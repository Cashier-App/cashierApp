...
const ModalAddIngredient = ({ setShowModalAdd }) => {
  ...
  if (data) {
    ...
    Swal.fire("Success", "Added ingredient successfuly", "success");
  }

  if (error) {
    toast.error("Invalid Add Item!", {
      position: "top-right",
      autoClose: 5000,
  ...
  const handleSubmit = (e) => {
    ...
    if (!name || !unit || !total) {
      ...
      addIngredient({
        variables: {
          addStockIngredientName: name,
          addStockIngredientUnit: unit,
          addStockIngredientTotal: Number(total),
        },
      });
    }
  };
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          <div className="border-0 p-10 rounded-lg shadow-xl relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="mt-4 self-center text-xl sm:text-sm text-gray-800">
              Please enter your credentials to add new ingredient
            </div>
